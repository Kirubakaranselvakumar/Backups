...
if ($patient_id) {
    $sql = "UPDATE patients SET firstname=?, middlename=?, lastname=?, dob=?, mobile=?, email=?, gender=?, city=?, district=?, state=?, country=?, pincode=?, bloodgroup=?, height=?, weight=?, bmi=?, maritalstatus=? WHERE patient_id=?";
